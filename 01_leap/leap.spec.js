...
describe('A leap year', () => {
  ...
  for (let i=0;i<leaps.length;i++) {
    test('year '+leaps[i]+' is leaf', () => expect(isLeap(leaps[i])).toEqual(true));
  }

  // TEST NOT LEAPS
  for (let j=0;j<leaps.length;j++) {
    test('year is NOT leaf', () => expect(isLeap(notleaps[j])).toEqual(false));
  }
